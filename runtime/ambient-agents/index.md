...
- **Eventarc**: Create an [Eventarc Standard trigger](https://cloud.google.com/eventarc/standard/docs/creating-triggers) or an [Eventarc Advanced pipeline](https://cloud.google.com/eventarc/advanced/docs/overview) routing to `/apps/{app_name}/trigger/eventarc`.
